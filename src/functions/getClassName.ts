 ...
 *
 * @param condition This is the basis upon which a value would be return. If truthy, the `className` is returned else an empty string `''` is returned.
 * @param className The className string to be returned. If it is undefined and `condition` is truthy, the condition is returned as a string instead.
 *
